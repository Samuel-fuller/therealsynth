...
enum controlID {
	...
	modSource_lfo1Intensity = 170,
	modSource_lfo2Intensity = 190,
	modSource_eg1Intensity = 210,
	modSource_eg2Intensity = 230,
	modDestination_osc1f0Intensity = 161,
	modDestination_osc2f0Intensity = 162,
	modDestination_filter1f0Intensity = 163,
	modDestination_filter1QIntensity = 164,
	modDestination_filter2f0Intensity = 165,
	modDestination_filter2QIntensity = 166,
	modDestination_osc1ShapeIntensity = 167,
	modDestination_osc2ShapeIntensity = 168,
	lfo1_osc1f0Switch = 171,
	lfo1_osc2Switch = 172,
	lfo1_filter1f0Switch = 173,
	lfo1_filter1QSwitch = 174,
	lfo1_filter2f0Switch = 175,
	lfo1_filter2QSwitch = 176,
	lfo1_osc1ShapeSwitch = 177,
	lfo1_osc2ShapeSwitch = 178
};
...
private:
	...
	double modSource_lfo1Intensity = 0.0;
	double modSource_lfo2Intensity = 0.0;
	double modSource_eg1Intensity = 0.0;
	double modSource_eg2Intensity = 0.0;
	double modDestination_osc1f0Intensity = 0.0;
	double modDestination_osc2f0Intensity = 0.0;
	double modDestination_filter1f0Intensity = 0.0;
	double modDestination_filter1QIntensity = 0.0;
	double modDestination_filter2f0Intensity = 0.0;
	double modDestination_filter2QIntensity = 0.0;
	double modDestination_osc1ShapeIntensity = 0.0;
	double modDestination_osc2ShapeIntensity = 0.0;
	...
	int lfo1_osc1f0Switch = 0;
	enum class lfo1_osc1f0SwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_osc1f0SwitchEnum::SWITCH_OFF, lfo1_osc1f0Switch)) etc... 

	int lfo1_osc2Switch = 0;
	enum class lfo1_osc2SwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_osc2SwitchEnum::SWITCH_OFF, lfo1_osc2Switch)) etc... 

	int lfo1_filter1f0Switch = 0;
	enum class lfo1_filter1f0SwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_filter1f0SwitchEnum::SWITCH_OFF, lfo1_filter1f0Switch)) etc... 

	int lfo1_filter1QSwitch = 0;
	enum class lfo1_filter1QSwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_filter1QSwitchEnum::SWITCH_OFF, lfo1_filter1QSwitch)) etc... 

	int lfo1_filter2f0Switch = 0;
	enum class lfo1_filter2f0SwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_filter2f0SwitchEnum::SWITCH_OFF, lfo1_filter2f0Switch)) etc... 

	int lfo1_filter2QSwitch = 0;
	enum class lfo1_filter2QSwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_filter2QSwitchEnum::SWITCH_OFF, lfo1_filter2QSwitch)) etc... 

	int lfo1_osc1ShapeSwitch = 0;
	enum class lfo1_osc1ShapeSwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_osc1ShapeSwitchEnum::SWITCH_OFF, lfo1_osc1ShapeSwitch)) etc... 

	int lfo1_osc2ShapeSwitch = 0;
	enum class lfo1_osc2ShapeSwitchEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(lfo1_osc2ShapeSwitchEnum::SWITCH_OFF, lfo1_osc2ShapeSwitch)) etc... 
