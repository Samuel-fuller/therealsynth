...
bool PluginCore::initPluginParameters()
{
	...
	// --- continuous control: LFO 1 Intensity
	piParam = new PluginParameter(controlID::modSource_lfo1Intensity, "LFO 1 Intensity", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modSource_lfo1Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: LFO 2 Intensity
	piParam = new PluginParameter(controlID::modSource_lfo2Intensity, "LFO 2 Intensity", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modSource_lfo2Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: EG 1 Intensity
	piParam = new PluginParameter(controlID::modSource_eg1Intensity, "EG 1 Intensity", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modSource_eg1Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: EG 2 Intensity
	piParam = new PluginParameter(controlID::modSource_eg2Intensity, "EG 2 Intensity", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modSource_eg2Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Osc 1 F0 Int.
	piParam = new PluginParameter(controlID::modDestination_osc1f0Intensity, "Osc 1 F0 Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_osc1f0Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Osc 2 F0 Int.
	piParam = new PluginParameter(controlID::modDestination_osc2f0Intensity, "Osc 2 F0 Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_osc2f0Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Filter 1 Cutoff Int.
	piParam = new PluginParameter(controlID::modDestination_filter1f0Intensity, "Filter 1 Cutoff Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_filter1f0Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Filter 1 Q Int.
	piParam = new PluginParameter(controlID::modDestination_filter1QIntensity, "Filter 1 Q Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_filter1QIntensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Filter 2 Cutoff Int.
	piParam = new PluginParameter(controlID::modDestination_filter2f0Intensity, "Filter 2 Cutoff Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_filter2f0Intensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Filter 2 Q Int.
	piParam = new PluginParameter(controlID::modDestination_filter2QIntensity, "Filter 2 Q Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_filter2QIntensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Osc 1 Shape Int.
	piParam = new PluginParameter(controlID::modDestination_osc1ShapeIntensity, "Osc 1 Shape Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_osc1ShapeIntensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Osc 2 Shape Int.
	piParam = new PluginParameter(controlID::modDestination_osc2ShapeIntensity, "Osc 2 Shape Int.", "", controlVariableType::kDouble, 0.000000, 1.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&modDestination_osc2ShapeIntensity, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- discrete control: 1-1 On/Off
	piParam = new PluginParameter(controlID::lfo1_osc1f0Switch, "1-1 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_osc1f0Switch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- discrete control: 1-2 On/Off
	piParam = new PluginParameter(controlID::lfo1_osc2Switch, "1-2 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_osc2Switch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- discrete control: 1-3 On/Off
	piParam = new PluginParameter(controlID::lfo1_filter1f0Switch, "1-3 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_filter1f0Switch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- discrete control: 1-4 On/Off
	piParam = new PluginParameter(controlID::lfo1_filter1QSwitch, "1-4 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_filter1QSwitch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- discrete control: 1-5 On/Off
	piParam = new PluginParameter(controlID::lfo1_filter2f0Switch, "1-5 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_filter2f0Switch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- discrete control: 1-6 On/Off
	piParam = new PluginParameter(controlID::lfo1_filter2QSwitch, "1-6 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_filter2QSwitch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- discrete control: 1-7 On/Off
	piParam = new PluginParameter(controlID::lfo1_osc1ShapeSwitch, "1-7 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_osc1ShapeSwitch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- discrete control: 1-8 On/Off
	piParam = new PluginParameter(controlID::lfo1_osc2ShapeSwitch, "1-8 On/Off", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&lfo1_osc2ShapeSwitch, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);
	...
	// --- controlID::modSource_lfo1Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483654);
	setParamAuxAttribute(controlID::modSource_lfo1Intensity, auxAttribute);

	// --- controlID::modSource_lfo2Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483654);
	setParamAuxAttribute(controlID::modSource_lfo2Intensity, auxAttribute);

	// --- controlID::modSource_eg1Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483654);
	setParamAuxAttribute(controlID::modSource_eg1Intensity, auxAttribute);

	// --- controlID::modSource_eg2Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483654);
	setParamAuxAttribute(controlID::modSource_eg2Intensity, auxAttribute);

	// --- controlID::modDestination_osc1f0Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_osc1f0Intensity, auxAttribute);

	// --- controlID::modDestination_osc2f0Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_osc2f0Intensity, auxAttribute);

	// --- controlID::modDestination_filter1f0Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_filter1f0Intensity, auxAttribute);

	// --- controlID::modDestination_filter1QIntensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_filter1QIntensity, auxAttribute);

	// --- controlID::modDestination_filter2f0Intensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_filter2f0Intensity, auxAttribute);

	// --- controlID::modDestination_filter2QIntensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_filter2QIntensity, auxAttribute);

	// --- controlID::modDestination_osc1ShapeIntensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_osc1ShapeIntensity, auxAttribute);

	// --- controlID::modDestination_osc2ShapeIntensity
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483652);
	setParamAuxAttribute(controlID::modDestination_osc2ShapeIntensity, auxAttribute);

	// --- controlID::lfo1_osc1f0Switch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_osc1f0Switch, auxAttribute);

	// --- controlID::lfo1_osc2Switch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_osc2Switch, auxAttribute);

	// --- controlID::lfo1_filter1f0Switch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_filter1f0Switch, auxAttribute);

	// --- controlID::lfo1_filter1QSwitch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_filter1QSwitch, auxAttribute);

	// --- controlID::lfo1_filter2f0Switch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_filter2f0Switch, auxAttribute);

	// --- controlID::lfo1_filter2QSwitch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_filter2QSwitch, auxAttribute);

	// --- controlID::lfo1_osc1ShapeSwitch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_osc1ShapeSwitch, auxAttribute);

	// --- controlID::lfo1_osc2ShapeSwitch
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::lfo1_osc2ShapeSwitch, auxAttribute);
...
bool PluginCore::initPluginPresets()
{
	...
	setPresetParameter(preset->presetParameters, controlID::eg2attackTime_mSec, 4.000000);
	setPresetParameter(preset->presetParameters, controlID::modSource_lfo1Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modSource_lfo2Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modSource_eg1Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modSource_eg2Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_osc1f0Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_osc2f0Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_filter1f0Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_filter1QIntensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_filter2f0Intensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_filter2QIntensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_osc1ShapeIntensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::modDestination_osc2ShapeIntensity, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_osc1f0Switch, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_osc2Switch, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_filter1f0Switch, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_filter1QSwitch, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_filter2f0Switch, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_filter2QSwitch, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_osc1ShapeSwitch, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1_osc2ShapeSwitch, 0.000000);
	addPreset(preset);
